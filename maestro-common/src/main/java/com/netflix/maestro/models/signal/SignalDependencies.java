...
public class SignalDependencies {
  ...
  /**
   * Marks every still-pending dependency as {@link StepDependencyMatchStatus#UNMATCHED}, used when
  ...
  public static class SignalDependency {
    ...
    /** Marks the dependency as {@link StepDependencyMatchStatus#UNMATCHED}. */
    private void markUnmatched() {
      this.status = StepDependencyMatchStatus.UNMATCHED;
    }
