...
public class MaestroSignalHandler implements SignalHandler {
  ...
  /** When enabled, marks still-pending dependencies as {@code UNMATCHED} on step termination. */
  ...
  /**
   * On step termination, marks any still-pending signal dependencies as {@code UNMATCHED} when
  ...
  public void onTermination(
    ...
    if (stepRuntimeSummary.getSignalDependencies().markPendingAsUnmatched()) {
      stepRuntimeSummary.flagToSync();
    }
  }
